...
def add_sent_report(sent):
    # the CT chest report into which the nodule descriptions are incorporated.
...
def generate_reports(num_nodules):
    ...
    for number in numbers:
        for x in range(num_per_category):
            ...
            nodules.append({"report": report, "sent": sentence, "Fleischner": recom,
                            "GPT-3.5":"", "GPT-4":"", "GPT-3.5_Fl":"", "GPT-4_Fl":"", "GPT-35_Tuned":""})
...
def main():
    ...
    headers = ["report", "sent", "Fleischner", "GPT-3.5", "GPT-4", "GPT-3.5_Fl", "GPT-4_Fl", "GPT-35_Tuned"]
    # generate_reports(10)
    ...
    for nodule in nodules:
        ...
        nodule["GPT-3.5_Fl"] = generate_recom_fleischner(nodule["report"], "gpt-3.5-turbo")
        nodule["GPT-4_Fl"] = generate_recom_fleischner(nodule["report"], "gpt-4")
        nodule["GPT-35_Tuned"] = generate_recom_tuned(nodule["report"], "ft:gpt-3.5-turbo-0613:personal:fl2017-27aug23-3:7rv6aq5b", fleischner_text)
